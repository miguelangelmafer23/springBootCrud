...
public class ListadoMascotasController {
	...
	@GetMapping(path = "/listadoConChip")
	public ModelAndView listadoMascotasChip(@RequestParam("chip") Boolean chip) {
		ModelAndView mav = new ModelAndView("listadoMascotasConChip");
		mav.addObject("listaMascotasconChip", repositorioMascotas.findByChip(chip));
		return mav;
	}
