...
<body>
	...
	<br>
	<div class="d-flex justify-content-center text-center">
			<form action="listadoConChip">
				<input type="hidden" id="chip" name="chip" value="true">
				<input type="submit" value="Mascotas con Chip" class="btn btn-info">
			</form>	
	</div>
	...
	<div class="row">
	    <div class="col-sm-12 offset-sm-0 col-md-8 offset-md-2">
			...
			<table class="table table-hover table-striped">    
			    ...
			    <tbody>
					<c:forEach items="${listaMascotas}" var="mas">
						<tr>
